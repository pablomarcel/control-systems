...
from stateSpaceAnalysis.stateTool.app import StateToolApp
from stateSpaceAnalysis.stateTool.apis import RunOptions, AnalyzerMode
...
def test_app_run_from_state_and_export():
    ...
    p = Path("stateSpaceAnalysis/stateTool/out") / out_file
    assert p.exists()
