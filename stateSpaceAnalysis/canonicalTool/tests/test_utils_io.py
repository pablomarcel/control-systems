...
import json
from stateSpaceAnalysis.canonicalTool.utils import parse_list, ensure_dir, substitute_kind, time_grid
from stateSpaceAnalysis.canonicalTool.io import save_json, default_out_path
...
def test_default_out_path_string():
    ...
    assert "stateSpaceAnalysis/canonicalTool/out" in p
