...
Works in two modes:
  1) From project root (preferred):  python -m stateSpaceDesign.robustTool.cli --help
...
if __package__ in (None, ""):
    ...
    from stateSpaceDesign.robustTool.io import save_json  # writes under package out/
else:
...
def main(argv=None):
    ...
    p = argparse.ArgumentParser(
        prog="stateSpaceDesign.robustTool",
    ...
    if args.export_json:
        if os.path.dirname(args.export_json):
            ...
            # hand off to package writer (writes under stateSpaceDesign/robustTool/out/)
