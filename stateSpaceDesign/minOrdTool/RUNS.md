...
```bash
python -m stateSpaceDesign.minOrdTool.tools.class_diagram --out out/minOrdTool_classes.png
...
```bash
python -m stateSpaceDesign.minOrdTool.tools.class_diagram --out out/minOrdTool_classes.dot
```
