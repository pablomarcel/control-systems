...
def test_cli_run_exports_json(tmp_path):
    ...
    cmd = [
        sys.executable, "-m", "stateSpaceDesign.gainMatrixTool.cli",
        "run",
        "--mode","K",
        "--A","0 1; -2 -3",
        "--B","0; 1",
...
def test_cli_batch_csv_and_yaml(tmp_path):
    ...
    cmd_csv = [sys.executable, "-m", "stateSpaceDesign.gainMatrixTool.cli", "batch",
    ...
    cmd_yaml = [sys.executable, "-m", "stateSpaceDesign.gainMatrixTool.cli", "batch",
