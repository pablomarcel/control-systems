...
Works in two modes:
  1) From project root (preferred):  python -m stateSpaceDesign.gainMatrixTool.cli --help
...
def main(argv=None):
    ...
    default_export = "out_json" if _SCRIPT_MODE else "stateSpaceDesign/gainMatrixTool/out_json"
    ...
    if args.cmd == "run":
        ...
        if args.export_json:
            ...
            if __package__ in (None, ""):
                from stateSpaceDesign.gainMatrixTool.io import JsonExporter
            else:
