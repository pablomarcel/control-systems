...
import numpy as np
from stateSpaceDesign.statePlotsTool.core import Simulator
from stateSpaceDesign.statePlotsTool.io import IOJSON
...
def test_states_via_outputs_path(monkeypatch):
    ...
    monkeypatch.setattr("stateSpaceDesign.statePlotsTool.core.Simulator._simulate_states_via_output",
