...
```bash
python -m stateSpaceDesign.statePlotsTool.cli --data stateSpaceDesign/statePlotsTool/in/io.json --scenario step --what y --backend none --save_csv step.csv --no_show
```
