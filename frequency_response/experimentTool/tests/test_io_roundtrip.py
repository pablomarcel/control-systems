...
from frequency_response.experimentTool.io import make_synth_csv, read_csv, export_summary
...
def test_make_and_read_csv(repo_root: Path):
    spec = ogata_7_25()
    csv_path = repo_root / "frequency_response" / "experimentTool" / "in" / "unit.csv"
...
def test_export_summary_json(repo_root: Path):
    ...
    prefix = repo_root / "frequency_response" / "experimentTool" / "out" / "summary_unit"
