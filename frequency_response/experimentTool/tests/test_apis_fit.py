...
from frequency_response.experimentTool.apis import fit_simple_from_csv, refine_fit, ExperimentService
from frequency_response.experimentTool.io import make_synth_csv, read_csv

def test_fit_and_refine_pipeline(repo_root: Path):
    spec_true = ogata_7_25()
    csv_path = repo_root / "frequency_response" / "experimentTool" / "in" / "fit_unit.csv"
