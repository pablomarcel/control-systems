# frequency_response/plotTool/tests/test_app_apis_cli_paths.py
...
def test_cli_help_runs():
    p = _run([PY, "-m", "frequency_response.plotTool.cli", "-h"], env=_env())
...
def test_cli_plotly_and_mpl_outputs(tmp_path):
    ...
    cmd1 = [
        PY, "-m", "frequency_response.plotTool.cli",
...
def test_apis_direct_call(tmp_path, monkeypatch):
    ...
    """
    from frequency_response.plotTool.app import PlotToolApp
    from frequency_response.plotTool.apis import PlotService
