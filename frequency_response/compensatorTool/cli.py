...
"""
frequency_response.compensatorTool.cli

Import shim:
- Supports both module mode:  python -m frequency_response.compensatorTool.cli
...
if __package__ in (None, ""):
    ...
    from frequency_response.compensatorTool.apis import (  # type: ignore
        PlantSpec,
        DesignOptions,
        PlotOptions,
        FrequencyGrid,
    ...
    try:
        from frequency_response.compensatorTool.apis import LeadDesignSpec, LeadDesignOptions  # type: ignore
        _HAVE_LEAD_API = True
    ...
    try:
        from frequency_response.compensatorTool.apis import LagDesignSpec, LagDesignOptions  # type: ignore
        _HAVE_LAG_API = True
    except Exception:  # pragma: no cover
    ...
    from frequency_response.compensatorTool.app import CompensatorApp  # type: ignore
    from frequency_response.compensatorTool.utils import parse_list_floats  # type: ignore
else:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        ...
        description=(
            ...
            "modernControl.frequency_response.compensatorTool"
        ),
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.mode == "lead":
        ...
        if __package__ in (None, ""):
            from frequency_response.compensatorTool.lead import LeadDesigner  # type: ignore
        else:
        ...
        if __package__ in (None, ""):
            from frequency_response.compensatorTool.lag import LagDesigner  # type: ignore
        else:
