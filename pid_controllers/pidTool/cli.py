...
if __package__ in (None, ""):
    ...
    from pid_controllers.pidTool.core import tf_from_args, Requirements
    from pid_controllers.pidTool.design import make_grids
    from pid_controllers.pidTool.app import PIDDesignerApp
else:
