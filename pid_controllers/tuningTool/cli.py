...
if __package__ in (None, ""):
    ...
    from pid_controllers.tuningTool.app import TuningApp
    from pid_controllers.tuningTool.utils import TuningInputs
    from pid_controllers.tuningTool.tools.tool_paths import OUT_DIR, ensure_outdir
else:
...
def _build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(prog="pid_controllers.tuningTool", description="Query PID tuning rules (Ziegler–Nichols, extendable).")
    ap.add_argument("--file", default="tuning_rules.json", help="Rules JSON file. If relative, resolved under pid_controllers/tuningTool/in.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if __package__ in (None, ""):
        from pid_controllers.tuningTool.apis import PrintAPI, ExportAPI
    else:
