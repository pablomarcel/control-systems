...
from pid_controllers.zeroPoleTool.app import ZeroPoleApp, AppConfig
from pid_controllers.zeroPoleTool.apis import ZeroPoleAPI, DesignRequest
from pid_controllers.zeroPoleTool.io import export_results
from pid_controllers.zeroPoleTool.core import plant_polys
...
def test_io_export_results_json_csv(tmp_path: Path):
    ...
    from pid_controllers.zeroPoleTool import io as io_mod
