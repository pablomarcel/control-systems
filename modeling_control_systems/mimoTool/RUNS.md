...
runroot mkdir -p modeling_control_systems/mimoTool/out
# -----------------------------------------------------------------------------
```
...
runroot python -m modeling_control_systems.mimoTool.cli --plant two_tank --no-show --no-steps --no-sigma \
  --save-json "modelingSystems/mimoTool/out/{plant}_summary.json"
```

```bash
# Thermal plant only
runroot python -m modeling_control_systems.mimoTool.cli --plant two_zone_thermal --no-show --no-steps --no-sigma \
  --save-json "modelingSystems/mimoTool/out/{plant}_summary.json"
```
...
runroot python -m modeling_control_systems.mimoTool.cli \
  --plant two_tank \
  --no-show \
...
runroot python -m modeling_control_systems.mimoTool.cli sphinx-skel modeling_control_systems/mimoTool/docs
```

```bash
# Build HTML docs to _build/html (requires sphinx, furo)
runroot python -m sphinx -b html modeling_control_systems/mimoTool/docs modeling_control_systems/mimoTool/docs/_build/html
```
...
runroot pytest modeling_control_systems/mimoTool/tests \
  --override-ini addopts= \
  --cov \
  --cov-config=modeling_control_systems/mimoTool/.coveragerc \
