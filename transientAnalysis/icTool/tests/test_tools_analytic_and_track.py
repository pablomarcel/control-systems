...
def test_analytic_over_and_under_damped():
    analytic = importlib.import_module("transientAnalysis.icTool.tools.analytic").analytic_solution
...
def test_track_decorator_executes():
    try:
        track = importlib.import_module("transientAnalysis.icTool.tools.diagram").track
    except Exception:
