# rootLocus/compensatorTool/tests/test_cli_lag_smoke.py
...
# This file lives at modernControl/rootLocus/compensatorTool/tests
...
def run_cli(args: List[str]) -> Tuple[int, str, List[str], dict]:
    ...
    # so 'rootLocus' is importable as a package.
