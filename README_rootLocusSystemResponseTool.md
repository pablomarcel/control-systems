...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ex6_6_step \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ex6_6_ramp \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/open_loop_demo \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ss_demo \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/expr_demo \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/file_demo \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ic_case1 \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ic_case2 \
  --log-level INFO
```
...
python -m rootLocus.systemResponseTool.cli run \
  ...
  --out-prefix rootLocus/systemResponseTool/out/ic_case1_direct \
  --log-level INFO
```
