...
"""frequencyResponse.plotTool.cli
Import shim so you can run both:
  - python -m frequencyResponse.plotTool.cli
  - python cli.py (from inside frequencyResponse/plotTool)
"""
import argparse
import os
import sys
...
if __package__ in (None, ""):
    ...
    from frequencyResponse.plotTool.app import PlotToolApp  # type: ignore
    from frequencyResponse.plotTool.apis import PlotService, PlotRequest  # type: ignore
    from frequencyResponse.plotTool.utils import build_logger, parse_csv_vals, parse_range4  # type: ignore
else:
