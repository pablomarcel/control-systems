...
def run_cmd(args: list[str]) -> tuple[int, str]:
    ...
    pre_cmd = [
        ...
        (
            ...
            "import pidControllers.rootLocusTool.cli as m; "
    ...
    # actual CLI run
    cmd = [sys.executable, "-m", "pidControllers.rootLocusTool.cli", *args]
    print("\n===== DEBUG: running CLI =====")
...
def test_cli_example_runs_no_plot():
    code, out = run_cmd([
        ...
        "--omega", "0.2", "4", "40",
        "--no_plot",
        "--export_json", "pidControllers/rootLocusTool/out/smoke.json",
    ])
