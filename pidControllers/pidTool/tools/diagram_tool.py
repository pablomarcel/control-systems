...
def discover_classes(package_root: str = "pidControllers.pidTool") -> list[tuple[str, str]]:
...
def main(argv=None):
    ...
    if args.emit_mermaid:
        ...
        out_dir = Path("pidControllers/pidTool/out"); out_dir.mkdir(parents=True, exist_ok=True)
