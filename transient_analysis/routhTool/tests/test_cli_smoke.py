# transient_analysis/routhTool/tests/test_cli_smoke.py
...
def run_cli(args: list[str]) -> tuple[int, str]:
    ...
    pkg_dir = repo_root / "transient_analysis" / "routhTool"
    cmd = [sys.executable, "-m", "transient_analysis.routhTool.cli", *args]
    p = subprocess.Popen(
