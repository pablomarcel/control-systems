# ---------------------------------
# File: transient_analysis/icTool/tools/diagram.py
# ---------------------------------
...
class DiagramTool:
    ...
    Usage:
        from transient_analysis.icTool import core, app, apis
    ...
    def from_modules(modules: Iterable[object]) -> "DiagramTool":
        ...
        for m in modules:
            for _, obj in inspect.getmembers(m, inspect.isclass):
                if obj.__module__.startswith("transient_analysis.icTool"):
                    classes.append(obj)
