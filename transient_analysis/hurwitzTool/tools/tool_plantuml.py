# =============================
# File: transient_analysis/hurwitzTool/tools/tool_plantuml.py
# =============================
...
def to_plantuml(mods: Iterable[ModuleType]) -> str:
    ...
    Usage:
        python -m transient_analysis.hurwitzTool.tools.tool_plantuml > hurwitz_classes.puml
...
if __name__ == "__main__":  # pragma: no cover
    import transient_analysis.hurwitzTool.core as core
    import transient_analysis.hurwitzTool.app as app
    import transient_analysis.hurwitzTool.apis as apis
