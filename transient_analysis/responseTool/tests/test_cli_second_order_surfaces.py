# transient_analysis/responseTool/tests/test_cli_second_order_surfaces.py
...
def project_out_dir() -> Path:
    ...
    Return the package out directory:
      <repo>/transient_analysis/responseTool/out
    """
    here = Path(__file__).resolve()
    response_tool_dir = here.parents[1]            # .../transient_analysis/responseTool
...
def run_cmd(args: List[str]) -> tuple[int, str]:
    ...
    cmd = [sys.executable, "-m", "transient_analysis.responseTool.cli"] + args
