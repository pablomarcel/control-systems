# -*- coding: utf-8 -*-
"""
CLI entry point for state_space_design.minOrdTool (Minimum-order observer, Ogata §10-5).

Works in two modes:
  1) From project root (preferred):  python -m state_space_design.minOrdTool.cli --help
...
def main(argv: list[str] | None = None) -> None:
    ...
    ap.add_argument("--export-json", default=None, help="Explicit JSON path; otherwise auto in state_space_design/minOrdTool/out/")
