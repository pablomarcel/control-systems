...
import numpy as np
import pytest
from state_space_design.observerStatePlotTool.utils import parse_time, parse_vec_real, to2d, safe_series, ensure_out_path
...
def test_to2d_and_safe_series_and_paths(tmp_path):
    ...
    assert out.endswith("state_space_design/observerStatePlotTool/out/tmp.csv")
