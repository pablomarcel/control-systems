...
# --- Import shim --------------------------------------------------------------
# Allow running as a script (python cli.py) OR as a module (-m state_space_design.observerStatePlotTool[.cli]).
try:
    ...
    import sys, pathlib
    pkg_dir = pathlib.Path(__file__).resolve().parent                       # .../state_space_design/observerStatePlotTool
