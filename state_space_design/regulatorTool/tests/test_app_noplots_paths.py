...
import importlib
from state_space_design.regulatorTool.app import _maybe_plot
from state_space_design.regulatorTool.apis import RegulatorRunRequest, RegulatorService
...
def test_app_maybe_plot_doesnt_plot_when_backends_false(monkeypatch):
    ...
    import state_space_design.regulatorTool.app as appmod
