...
Then render with:
  dot -Tpng state_space_design/lqrTool/out/lqrTool.dot -o state_space_design/lqrTool/out/lqrTool.png
"""
...
def main():
    ...
    ap.add_argument("--out", default="state_space_design/lqrTool/out/lqrTool.dot")
    args = ap.parse_args()
