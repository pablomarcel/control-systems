...
```bash
runroot python -m state_space_analysis.stateSolnTool.cli [OPTIONS]
```
...
runroot mkdir -p state_space_analysis/stateSolnTool/out
# -----------------------------------------------------------------------------
```
...
## 0) Quick help
```bash
runroot python -m state_space_analysis.stateSolnTool.cli --help
```
...
```bash
runroot python -m state_space_analysis.stateSolnTool.cli \
  --example ogata_9_1 \
...
```bash
runroot python -m state_space_analysis.stateSolnTool.cli --example ogata_9_1 --u 1 --verify
```

### B) Failure mode (missing `--den`): should print an error & nonzero exit
```bash
runroot python -m state_space_analysis.stateSolnTool.cli --num "1,2,3"
```
